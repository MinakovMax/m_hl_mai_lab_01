#ifndef HTTPTEMPERATUREWEBSERVER_H
#define HTTPTEMPERATUREWEBSERVER_H
...
#include "../web_server/handlers/tempearture_handler.h"

class TemperatureOtherHandler : public HTTPRequestHandler
{

public:
    TemperatureOtherHandler(const std::string &format) : _format(format)
    {
    }
...
public:
    ...
    {
                if (hasSubstrT(request.getURI(),"/temperature") ||
                    hasSubstrT(request.getURI(),"/get_temperatures")) {
                    return new TemperatureHandler(_format);
            }    
        return new TemperatureOtherHandler(_format);
    }
...
class HTTPTemperatureOtherWebServer : public Poco::Util::ServerApplication
{
public:
    int main([[maybe_unused]] const std::vector<std::string> &args)
    {

        database::Temperature::init();
